...
**Abstract**:
This course will give an introduction to modern rigidity theory. Rigidity theory studies realization spaces of discrete geometric objects, such as frameworks, polytopes and matroids. The subject is classically motivated from physics and engineering contexts, but has since developed its own intrinsic mathematical appeal. The archetypical question is whether a given geometric object admits a continuous deformation (a flex) that preserves its combinatorial structure together with certain metric measurements, e.g. lengths, co-planarities or angles. At its core, this amounts to a local and global study of real algebraic sets. These objects can be universally complicated, and rigidity theory needed to develop several paradigms to deal with this apparent intractability. Today, the theory draws from a broad spectrum of mathematical ideas, such as from computational algebraic geometry, polynomial optimization, convex geometry, tropical geometry, and spectral graph theory. 

This course will start out with a general introduction to the foundations of rigidity theory and present the paradigms of first-order theory and generic rigidity. The course will continue with a selection of modern combinatorial and geometric topics close to current research. It will address notions of rigidity that arise in the study of polytopes and matroids.
